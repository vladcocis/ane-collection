...
export default async (req, res) => {
    ...
    const response = await executeQuery({
		query: `SELECT product_reviews.product_id, product_reviews.user_id, product_reviews.rating, product_reviews.message, product.product_name, product_categories.name 
